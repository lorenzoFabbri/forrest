...
test_that("build_sections() inserts header rows at section boundaries", {
  ...
  res <- build_sections(
    df = df, estimate = "estimate", lower = "lower", upper = "upper",
    label = "study", is_summary = NULL, weight = NULL,
    section = "region", section_spacer = FALSE, section_indent = FALSE
  )
...
test_that("build_sections() section_indent = TRUE prepends two spaces", {
  ...
  res <- build_sections(
    df = df, estimate = "estimate", lower = "lower", upper = "upper",
    label = "study", is_summary = NULL, weight = NULL,
    section = "region", section_spacer = FALSE, section_indent = TRUE
  )
...
test_that("build_sections() section_spacer = TRUE adds blank rows", {
  ...
  res <- build_sections(
    df = df, estimate = "estimate", lower = "lower", upper = "upper",
    label = "study", is_summary = NULL, weight = NULL,
    section = "region", section_spacer = TRUE, section_indent = FALSE
  )
...
test_that("build_sections() cols columns are empty for header and spacer rows", {
  df <- data.frame(
    region   = c("Asia", "Asia"),
    study    = c("S1", "S2"),
    estimate = c(0.1, 0.2),
...
test_that("build_sections() subsection inserts sub-headers", {
  ...
  res <- build_sections(
    df = df, estimate = "estimate", lower = "lower", upper = "upper",
    label = "study", is_summary = NULL, weight = NULL,
    section = "domain", subsection = "type",
    section_spacer = FALSE, section_indent = FALSE
  )
  # 2 section headers + 3 subsection headers (x,y in A; x in B; y in B) + 5 data = 11
  expect_equal(sum(res$is_section_header), 2L)
...
test_that("build_sections() subsection data rows indented by 4 spaces", {
  ...
  res <- build_sections(
    ...
    label = "study", is_summary = NULL, weight = NULL,
    section = "domain", subsection = "type",
    section_spacer = FALSE, section_indent = TRUE
  )
  data_rows <- res$df[!res$is_section_header & !res$is_subsection_header & !res$is_spacer, ]
  expect_true(all(startsWith(data_rows$study, "    ")))
})
...
test_that("forrest() ref_label = TRUE appends (Ref.) to NA-estimate rows", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", section = "domain", ref_label = TRUE)
  )
})
...
test_that("forrest() section + stripe renders without error", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "study", section = "region", stripe = TRUE)
  )
})
...
test_that("forrest() section + is_summary renders without error", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "study", section = "region", is_summary = "is_sum")
  )
})
...
test_that("forrest() subsection renders without error", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "study", section = "domain", subsection = "type")
  )
})
...
test_that("forrest() errors when widths length is wrong", {
  ...
  expect_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            cols = c("OR" = "or_text"), widths = c(1, 2)),
    "widths"
  )
})
...
test_that("forrest() returns NULL invisibly", {
  ...
  on.exit(dev.off())
  dat <- basic_dat()
  result <- forrest(dat, estimate = "estimate", lower = "lower", upper = "upper")
  expect_null(result)
})
...
test_that("forrest() renders with dodge = TRUE", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", group = "period", dodge = TRUE)
  )
})
...
test_that("forrest() dodge works with cols (row-level text)", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", group = "period", dodge = TRUE,
            header = "Exposure", cols = c("Coef" = "txt"))
  )
})
...
test_that("forrest() cols_by_group = TRUE ignored when dodge = FALSE", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", dodge = FALSE, cols_by_group = TRUE,
            cols = c("OR" = "txt"))
  )
})
...
test_that("forrest() dodge works with stripe = TRUE", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", group = "period", dodge = TRUE, stripe = TRUE)
  )
})
...
test_that("forrest() section + dodge renders without error", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "study", section = "region", group = "period", dodge = TRUE)
  )
})
...
test_that("forrest() renders with dodge + group + shape", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", group = "period", shape = "sex", dodge = TRUE)
  )
})
...
test_that("forrest() shape legend can be suppressed", {
  ...
  expect_no_error(
    forrest(dat, estimate = "estimate", lower = "lower", upper = "upper",
            label = "label", shape = "sex", legend_shape_pos = NULL)
  )
})
