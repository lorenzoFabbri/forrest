...
Set `dodge = TRUE` and supply a `group` column to stack multiple CIs within
each row — useful for comparing results across time periods, sexes, models,
or any other categorical dimension.
